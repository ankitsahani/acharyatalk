                ...
                <div class="card ">
                  <div class="card-body ">
                   ...
                   <table class="table table-striped">
                      ...
                      <tbody>
                          <?php 
                          foreach($astrologer_list as $user){
                          ?>
                        <tr>
                          <td class="py-1">
                          ...
                          <td><a href="<?php echo base_url();?>index.php/admin/users/astrologerdelete/<?php echo $user->id;?>"> <button onclick="return confirm('Are you sure you want to delete this category?');"  class="btn btn-sm btn-icon btn-rounded btn-primary"> delete </button></a></td>
                        </tr>
                    ...
                    <!-- edit user modal     -->
                       <div class="modal fade" id="edituser<?php echo $user->id;?>">
                        <div class="modal-dialog">
                          ...
                          <form class="form-horizontal" method="post" action="<?php echo base_url();?>index.php/admin/users/astrologeredit">
